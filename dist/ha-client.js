 ...
 */
export function resolveHaToken() {
    ...
    throw new Error("No HA token available. Set HA_TOKEN_CMD or HA_TOKEN_FILE environment variable.");
}
/**
...
export class HaClient {
    ...
    async get(path, schema) {
        ...
        if (!parsed.success) {
            ...
            throw new Error(`HA API response validation failed for ${path}: ${parsed.error.message}`);
        }
        return parsed.data;
    }
    /**
     ...
     */
    async getMusicAssistantEntries() {
